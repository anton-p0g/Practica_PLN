...
hist(n_tokens_titulos,
     breaks = seq(0, 50, 1), ylim = c(0, 3500), main = "Histograma títulos", col = "blue",
     border = "white", xlab = "Número de tokens", ylab = "Frecuencia"
)
hist(n_tokens_summary,
     breaks = seq(0, 180, 2), ylim = c(0, 3500), main = "Histograma resúmenes", col = "red",
     border = "white", xlab = "Número de tokens", ylab = "Frecuencia"
)
```
...
![Histograma de títulos y resúmenes con SpacyR](spacy_hist.png)
![Histograma de títulos y resúmenes con UDPipe](udpipe_hist.png)

Como podemos ver, ambos histogramas son casi idénticos. Así, confirmamos que los resultados obtenidos con `udpipe` son consistentes con los obtenidos previamente con `spacy`.
