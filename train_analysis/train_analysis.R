...
# Run the test using your parsed data
...
test_specific_frequency_summary <- function(freq, freq_verbs_titles, list_verbs_text, list_verbs_title_unique, corpus_ids) {
  # Find the documents with the specified frequency
  ...
  for (doc_id in matching_docs) {
    ...
    cat("Matched Count (Summaries):", length(matched_title_verbs), "\n")
  }
}
test_specific_frequency_summary(44, freq_verbs_titles, list_verbs_text, list_verbs_title_unique, corpus_ids)
test_specific_frequency_summary(30, freq_verbs_titles, list_verbs_text, list_verbs_title_unique, corpus_ids)